...
registerForm.addEventListener('submit', async (e) => {
    ...
    const email = registerForm.querySelector('#register-form > .row > input[name="email"]').value;
    const password = registerForm.querySelector('#register-form > .row > input[name="password"]').value;
