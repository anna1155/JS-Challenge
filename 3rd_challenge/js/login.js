...
loginForm.addEventListener('submit', async (e) => {
    ...
    const email = loginForm.querySelector('#login-form > .row > input[name="email"]').value;
    const password = loginForm.querySelector('#login-form > .row > input[name="password"]').value;
